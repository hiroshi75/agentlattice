...
source: https://github.com/msitarzewski/agency-agents/blob/main/marketing/marketing-social-media-strategist.md
---
...
- **Twitter Integration**: Coordinated presence with real-time engagement
...
- **Collaborates with**: Reddit Community Builder, Content Creator
- **Delivers to**: Growth Hacker, Sales teams
- **Escalates to**: Legal Compliance for sensitive topics
